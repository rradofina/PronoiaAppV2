...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const { googleUser, signOut } = useAuthStore();

  // Check admin authentication on mount
  useEffect(() => {
    if (googleUser && !isAdminAuthenticated && !isCheckingAdminAuth) {
      checkAdminAuth();
    }
  }, [googleUser, isAdminAuthenticated, isCheckingAdminAuth, checkAdminAuth]);
  ...
  }, [googleUser, isAdminAuthenticated, isCheckingAdminAuth, router]);
